...
*Detected across 66 repositories.*

| Architecture | Repos | Share |
|-------------|-------|-------|
| Machine Learning Systems | 38 | 57.6% |
| API Architecture | 18 | 27.3% |
| AI-Native Architecture | 16 | 24.2% |
| Event-Driven Architecture | 8 | 12.1% |
| Pipeline Architecture | 6 | 9.1% |
| Microservices | 3 | 4.5% |
| Data Architecture | 3 | 4.5% |
| Multi Tenant SaaS | 2 | 3.0% |
| Actor Model | 2 | 3.0% |
| Domain-Driven Design | 2 | 3.0% |
| API Gateway | 1 | 1.5% |
...
**Languages**  
**PHP** · **Python** · **Swift** · *Blade* · *HTML* · *MQL5* · *Java* · *CSS* · *JavaScript* · *Hack* · *TypeScript* · *PowerShell* · *C++* · *SCSS* · *Shell* · *Less* · *Roff*
...
**Other**  
*DockerCompose* · *Express* · *Flask* · *Stylus*
...
- **[http-kernel](https://github.com/joel767443/http-kernel)** — No README summary available.  
  *Tech:* PHP (100.0%)
- **[framework-cli](https://github.com/joel767443/framework-cli)** — No README summary available.  
  *Tech:* PHP (100.0%)
- **[form-request-validation](https://github.com/joel767443/form-request-validation)** — No README summary available.  
  *Tech:* PHP (100.0%)
